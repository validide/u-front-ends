((window, ufe, undefined) => {
  ...
  jsComponentScript.skip = () => !!(window.demo_components && window.demo_components.MyCounterJavaScriptWrapper);
  ...
  ceComponentScript.skip = () => !!window.customElements.get("my-counter-wrapper");
  ...
  function init() {
    root
      .initialize()
      .then((rootRes) => rootRes.mount())
      .then((rootRes) => {
        document.getElementById("content").classList.remove("d-none");

        document.getElementById("toggler-js").addEventListener("click", async (e) => {
          e.preventDefault();
          await toggleJavaScriptComponent(rootRes);
        });

        document.getElementById("toggler-ce").addEventListener("click", async (e) => {
          e.preventDefault();
          await toggleCustomElementComponent(rootRes);
        });

        document.getElementById("toggler-embedded").addEventListener("click", async (e) => {
          e.preventDefault();
