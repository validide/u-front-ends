...
import { MockCrossWindowContentCommunicationHandler } from "../../../../test/mocks/mockCrossWindowContentCommunicationHandler";
import {
  CommunicationsEvent,
  CommunicationsEventKind,
  ContentCommunicationHandlerMethods,
  CrossWindowContentCommunicationHandler,
} from "../../../index";
...
describe("CrossWindowContentCommunicatinsHandler", () => {
  ...
  it("requires a handler and methods as parameters", () => {
    ...
    expect(() => new CrossWindowContentCommunicationHandler(_mngr, methods)).not.to.throw();
  });
